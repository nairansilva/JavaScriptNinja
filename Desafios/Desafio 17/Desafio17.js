(function () {
    ...
    */
    ...
    // ?
    console.log(text.replace(/(Manuel Marques de Sousa)/g, "Nairan Alves Silva"))
    /*
    ...
    */
    ...
    // ?
    console.log(
        text.replace(/(O Centauro de Luvas)/g, function (capturaTotal, frase) {
    ...
    */
    ...
    function getMonthNumber(mouthName) {
        if (mouthName.toUpperCase() === "março".toUpperCase()) {
            return '03'
        } else if (mouthName.toUpperCase() === "junho".toUpperCase()) {
            return "06"
        } else if (mouthName.toUpperCase() === "julho".toUpperCase()) {
            return "07"
        } else if (mouthName.toUpperCase() === "setembro".toUpperCase()) {
            return '09'
        } else if (mouthName.toUpperCase() === "dezembro".toUpperCase()) {
            return '12'
        } else {
    ...
    */
    ...
    function changeDateFormat(completo, dia, mes, ano) {
        return dia + '/' + getMonthNumber(mes) + '/' + ano
    }

    console.log(text.replace(regexDate, changeDateFormat))
})();